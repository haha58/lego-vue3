<template>
  <div class="template-list-component">
    <a-row :gutter="16">
      <a-col v-for="item in templateList" :key="item.id" :span="6" class="poster-item">
        <a-card hoverable>
          <template #cover>
...
export default defineComponent({
  ...
  props: {
    templates: {
      ...
      required: true,
      default: () => [] as TemplateProps[]
    }
  },
  setup(props) {
    const templateList = computed<TemplateProps[]>(() => props.templates)
